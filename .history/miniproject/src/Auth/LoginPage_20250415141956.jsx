...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-pink-100 relative overflow-hidden flex items-center justify-center px-4">
      ...
      {/* Main content */}
      <motion.div
        className="relative w-full max-w-md bg-white/90 backdrop-blur-md rounded-2xl p-8 border border-pink-200 shadow-lg"
        style={{
      ...
      >
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 bg-white/80 border-pink-200 text-pink-600 h-12"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 rounded border-pink-200 bg-white/80 text-pink-500 focus:ring-pink-500"
                />
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white/90 text-pink-400">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <Button
                ...
                className="bg-white/80 border-pink-200 text-pink-500 hover:bg-pink-50 h-12"
              >
        ...
        <div className="mt-6 text-center">
          <Button
            ...
            className="bg-white/80 border-pink-200 text-pink-500 hover:bg-pink-50 h-12 w-full"
          >
